...
public class Seg {
    ...
    public void storeSeg(final Document doc, final Element mazeXML,
        ...
        //Log.v("Seg1", String.valueOf(getColor()[0]));
        //Log.v("Seg2", String.valueOf(getColor()[1]));
        //Log.v("Seg3", String.valueOf(getColor()[2]));
        //Log.v("SegGET", "String" + String.valueOf(Color.rgb(123, 20, 20)));
        ...
        MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number + "_" + i,
                (MazePanel.getRGB(getColor()[0], getColor()[1], getColor()[2])));//TODO make this reference mazePanel

        Log.v("colorComponents", "red " +String.valueOf(getColor()[0]) + " green " + getColor()[1] + " blue " +  getColor()[2]);
        Log.v("color", String.valueOf(MazePanel.getRGB(getColor()[0], getColor()[1], getColor()[2])));
        // TODO is this the part that we had to change for storing a color
    }
